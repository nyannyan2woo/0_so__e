    ...
    apartmentOptions = {
        {
            ...
            label = 'マンション',
            description = '観光客や浮浪者の喧騒から離れたデル・ペロ・ビーチで、優雅なオーシャンビューを満喫。',
            enter = vec3(-1447.35, -537.84, 34.74)
        },
        {
            interior = 'DellPerroHeightsApt7',
            label = 'マンション',
            description = '豪華なデル・ペロ・ヘイツの複合アパート。都会の景色を眺めたい、そんなあなたに。',
            enter = vec3(-1447.35, -537.84, 34.74)
        },
        {
            interior = '4IntegrityWayApt28',
            label = 'マンション',
            description = '発展著しい注目のエリア。窓からは街が造り上げられていく活気あふれる様子を眺めることができます。',
            enter = vec3(-59.4, -616.29, 37.36)
        },
        {
            interior = '4IntegrityWayApt30',
            label = 'マンション',
            description = '圧倒的な広さを誇る室内。ここを訪れた友人は、その資産価値に驚くことでしょう。',
            enter = vec3(-47.52, -585.86, 37.95)
        },
        {
            interior = 'RichardMajesticApt2',
            label = 'マンション',
            description = '息を呑むような高級コンドミニアム。AKANレコードやクリニックへもすぐの好立地。',
            enter = vec3(-936.15, -378.91, 38.96)
        },
        {
            interior = 'TinselTowersApt42',
            label = 'マンション',
            description = 'ロスサントスで最も羨望を集めるタワー。理想のアーバンライフを実現する究極の居住空間。',
