...
local function knockDoorAnim(home)
    ...
    if home then
        ...
        exports.lation_ui:showText({
            description = locale('info.other_dealers_button'),
            keybind = 'E',
    ...
    if config.useTarget then
        ...
        drugDeliveryZone = lib.zones.box({
            ...
            onEnter = function()
                inDeliveryZone = true
                exports.lation_ui:showText({
                    description = locale('info.deliver_items_button', activeDelivery.amount, exports.ox_inventory:Items()[activeDelivery.itemData.item].label),
                    keybind = 'E',
                    icon = 'fas fa-user-secret'
                })
                CreateThread(function()
