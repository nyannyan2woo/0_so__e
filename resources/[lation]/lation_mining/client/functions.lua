...
function ShowNotification(message, type)
    if shared.setup.notify == 'lation_ui' then
        exports.lation_ui:notify({ title = '採掘', message = message, type = type, icon = 'fas fa-fire' })
    ...
    elseif shared.setup.notify == 'okok' then
        exports['okokNotify']:Alert('採掘', message, 5000, type, false)
    elseif shared.setup.notify == 'sd-notify' then
        exports['sd-notify']:Notify('採掘', message, type)
    elseif shared.setup.notify == 'wasabi_notify' then
        exports.wasabi_notify:notify('採掘', message, 5000, type, false, 'fas fa-fire')
