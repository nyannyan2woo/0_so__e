return {
    ...
    locations = {
        ...
        stations = {
            {label = 'ミッション・ロウ警察署', coords = vec3(434.0, -983.0, 30.7)},
            {label = 'サンディ・ショアーズ警察署', coords = vec3(1853.4, 3684.5, 34.3)},
            -- {label = 'ワインウッド警察署', coords = vec3(637.1, 1.6, 81.8)},
            -- {label = 'ヴェスプッチ警察署', coords = vec3(-1092.6, -808.1, 19.3)},
            -- {label = 'デイビス警察署', coords = vec3(368.0, -1618.8, 29.3)},
            -- {label = 'パレート・ベイ警察署', coords = vec3(-448.4, 6011.8, 31.7)},
        },
    },
