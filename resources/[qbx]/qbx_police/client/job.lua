        ...
        lib.zones.box({
            ...
            onEnter = function()
                ...
                exports.lation_ui:showText({
                    description = locale(QBX.PlayerData.job.onduty and 'info.off_duty' or 'info.on_duty'),
                    keybind = 'E',
    ...
    for i = 1, #sharedConfig.locations.trash do
        lib.zones.box({
            ...
            onEnter = function()
                ...
                inPrompt = true
                exports.lation_ui:showText({
                    description = locale('info.trash_enter'),
                    keybind = 'E',
                    icon = 'fas fa-hand-paper'
                })
                uiPrompt('trash', i)
    ...
    for i = 1, #sharedConfig.locations.fingerprint do
        lib.zones.box({
            ...
            onEnter = function()
                ...
                inPrompt = true
                exports.lation_ui:showText({
                    description = locale('info.scan_fingerprint'),
                    keybind = 'E',
                    icon = 'fas fa-hand-paper'
                })
    ...
    for i = 1, #sharedConfig.locations.helicopter do
        lib.zones.box({
            ...
            onEnter = function()
                ...
                uiPrompt('heli')
                exports.lation_ui:showText({
                    description = locale(cache.vehicle and 'info.store_heli' or 'info.take_heli'),
                    keybind = 'E',
                    icon = 'fas fa-hand-paper'
                })
            end,
    ...
    for i = 1, #sharedConfig.locations.impound do
        lib.zones.box({
            ...
            onEnter = function()
                ...
                currentGarage = i
                exports.lation_ui:showText({
                    description = locale(cache.vehicle and 'info.impound_veh' or 'menu.pol_impound'),
                    keybind = 'E',
                    icon = 'fas fa-hand-paper'
                })
                uiPrompt('impound')
    ...
    for i = 1, #sharedConfig.locations.vehicle do
        lib.zones.box({
            ...
            onEnter = function()
                ...
                currentGarage = i
                exports.lation_ui:showText({
                    description = locale(cache.vehicle and 'info.store_veh' or 'info.grab_veh'),
                    keybind = 'E',
                    icon = 'fas fa-hand-paper'
                })
                uiPrompt('garage')
