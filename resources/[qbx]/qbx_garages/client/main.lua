            ...
            onEnter = function()
                    ...
                    dropZone = lib.zones.sphere({
                        ...
                        onEnter = function()
                            ...
                            exports.lation_ui:showText({
                                description = locale('info.park_e'),
                                keybind = 'E',
                ...
                coordsZone = lib.zones.sphere({
                    ...
                    onEnter = function()
                        ...
                        exports.lation_ui:showText({
                            description = (garage.type == GarageType.DEPOT and locale('info.impound_e')) or (cache.vehicle and locale('info.park_e')) or locale('info.car_e'),
                            keybind = 'E',
                            icon = 'fa-solid fa-warehouse'
                        })
                    end,
