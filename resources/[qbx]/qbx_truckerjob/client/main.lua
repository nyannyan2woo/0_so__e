...
local function createMainZone()
    ...
    function innerZone:onEnter()
        ...
        if not isOpen then
            exports.lation_ui:showText({
                description = locale('info.pickup_paycheck'),
                keybind = 'E',
    ...
    function innerZone:onExit()
        local isOpen, currentText = exports.lation_ui:isOpen()
...
local function createVehicleZone()
    ...
    function innerZone:onEnter()
        ...
        if not isOpen then
            exports.lation_ui:showText({
                description = locale(cache.vehicle and 'info.store_vehicle' or 'info.vehicles'),
                keybind = 'E',
