return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 5000, bank = 50000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
    ...
    characters = {
        playersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
            ['license2:f7c95107e2ff0ea6e51630acba123ebccec63dff'] = 5,
        },
