...
const app = Vue.createApp({
  ...
  methods: {
    ...
    resetStorage: function(event) {
      ...
      localStorage.clear();
      this.isOutMapChecked = this.initIsOutMapChecked();
      this.isOutCompassChecked = this.initIsOutCompassChecked();
      this.isCompassFollowChecked = this.initIsCompassFollowChecked();
      this.isMapNotifChecked = this.initIsMapNotifChecked();
      this.isLowFuelChecked = this.initIsLowFuelChecked();
      this.isCinematicNotifChecked = this.initIsCinematicNotifChecked();
      this.isDynamicHealthChecked = this.initIsDynamicHealthChecked();
      this.isDynamicArmorChecked = this.initIsDynamicArmorChecked();
      this.isDynamicHungerChecked = this.initIsDynamicHungerChecked();
      this.isDynamicThirstChecked = this.initIsDynamicThirstChecked();
      this.isDynamicStressChecked = this.initIsDynamicStressChecked();
      this.isDynamicOxygenChecked = this.initIsDynamicOxygenChecked();
      this.isChangeFPSChecked = this.initIsChangeFPSChecked();
      this.isToggleMapShapeChecked = this.initIsToggleMapShapeChecked();
      this.isHideMapChecked = this.initIsHideMapChecked();
      this.isToggleMapBordersChecked = this.initIsToggleMapBordersChecked();
      this.isDynamicEngineChecked = this.initIsDynamicEngineChecked();
      this.isDynamicNitroChecked = this.initIsDynamicNitroChecked();
      this.isChangeCompassFPSChecked = this.initIsChangeCompassFPSChecked();
      this.isShowCompassChecked = this.initIsShowCompassChecked();
      this.isShowStreetsChecked = this.initIsShowStreetsChecked();
      this.isPointerShowChecked = this.initIsPointerShowChecked();
      this.isDegreesShowChecked = this.initIsDegreesShowChecked();
      this.isCineamticModeChecked = this.initIsCineamticModeChecked();
      resetStorage()
    },
