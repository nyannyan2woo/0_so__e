    ...
    lib.registerContext({
        ...
        onExit = not config.useTarget and function()
            exports.lation_ui:showText({
                description = groupType == 'gang' and locale('menu.gang_management') or locale('menu.boss_management'),
                keybind = 'E',
        ...
        lib.zones.box({
            ...
            onEnter = function()
                if zoneInfo.groupName == QBX.PlayerData[zoneInfo.type].name and QBX.PlayerData[zoneInfo.type].isboss then
                    exports.lation_ui:showText({
                        description = zoneInfo.type == 'gang' and locale('menu.gang_management') or locale('menu.boss_management'),
                        keybind = 'E',
                        icon = 'right-to-bracket'
                    })
                end
