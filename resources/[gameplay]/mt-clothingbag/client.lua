...
RegisterNetEvent('mt-clothingbag:client:openBag', function()
    QBCore.Functions.Progressbar('name_here', 'バッグを地面に置いています...', 2000, false, true, {
...
RegisterNetEvent('mt-clothingbag:client:openBag2', function(obj)
    QBCore.Functions.Progressbar('name_here', 'バッグを開けています...', 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('mt-clothingbag:client:progressDespawnBag', function(obj)
    QBCore.Functions.Progressbar('taking_cloth', 'バッグから服を取り出しています...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Progressbar('picking_bag', 'バッグを拾っています...', 2000, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
